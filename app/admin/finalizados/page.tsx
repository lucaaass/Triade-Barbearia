...
const Finalizados = async ({ searchParams }: { searchParams: SearchParams }) => {
  ...
  const [finishedBookings, totalBookings] = await Promise.all([
    db.booking.findMany({
      where: {
        date: {
          lt: new Date(),
  ...
  return (
    <>
      ...
      <div className="px-5 py-6">
        ...
        <h1 className="text-xl font-bold mt-8 mb-6">Agendamentos Finalizados</h1>
